 ...
 * Game Assets Mapping
 * 
 * Maps each game ID to its visual assets: icon component name (Lucide), 
 * background image path, and color palette.
 * 
 * Game images are 3D-rendered illustrations generated via Stable Diffusion.
 * Place generated images in /public/game-images/{game_id}.png
 */
...
export const GAME_ASSETS: Record<string, GameAsset> = {
  ...
  syllable_stomper: {
    icon: "Music",
    image: "/game-images/syllable_stomper.png",
  ...
  phoneme_blender: {
    icon: "FlaskConical",
    image: "/game-images/phoneme_blender.png",
  ...
  sound_swap: {
    icon: "ArrowLeftRight",
    image: "/game-images/sound_swap.png",
  ...
  speed_namer: {
    icon: "Rocket",
    image: "/game-images/speed_namer.png",
  ...
  flash_card_frenzy: {
    icon: "Layers",
    image: "/game-images/flash_card_frenzy.png",
  ...
  letter_stream: {
    icon: "Waves",
    image: "/game-images/letter_stream.png",
  ...
  sequence_keeper: {
    icon: "ListOrdered",
    image: "/game-images/sequence_keeper.png",
  ...
  backward_spell: {
    icon: "RotateCcw",
    image: "/game-images/backward_spell.png",
  ...
  story_recall: {
    icon: "BookOpen",
    image: "/game-images/story_recall.png",
  ...
  dual_task_challenge: {
    icon: "Brain",
    image: "/game-images/dual_task_challenge.png",
  ...
  letter_detective: {
    icon: "Search",
    image: "/game-images/letter_detective.png",
  ...
  tracking_trail: {
    icon: "Route",
    image: "/game-images/tracking_trail.png",
  ...
  pattern_matcher: {
    icon: "Puzzle",
    image: "/game-images/pattern_matcher.png",
  ...
  mirror_image: {
    icon: "FlipHorizontal",
    image: "/game-images/mirror_image.png",
  ...
  visual_closure: {
    icon: "PuzzleIcon",
    image: "/game-images/visual_closure.png",
  ...
  phrase_flash: {
    icon: "Zap",
    image: "/game-images/phrase_flash.png",
  ...
  word_ladder: {
    icon: "TrendingUp",
    image: "/game-images/word_ladder.png",
  ...
  repeated_reader: {
    icon: "BookMarked",
    image: "/game-images/repeated_reader.png",
  ...
  sight_word_sprint: {
    icon: "Rabbit",
    image: "/game-images/sight_word_sprint.png",
  ...
  main_idea_hunter: {
    icon: "Target",
    image: "/game-images/main_idea_hunter.png",
    gradient: ["#ECFDF5", "#6EE7B7"],
    bgLight: "#ECFDF5",
    accent: "#059669",
  },
  inference_detective: {
    icon: "ScanSearch",
    image: "/game-images/inference_detective.png",
  ...
  vocabulary_builder: {
    icon: "Building2",
    image: "/game-images/vocabulary_builder.png",
    gradient: ["#EFF8FF", "#93C5FD"],
    bgLight: "#EFF8FF",
    accent: "#1D4ED8",
  },
  story_sequencer: {
    icon: "Film",
    image: "/game-images/story_sequencer.png",
...
export const CATEGORY_ASSETS: Record<DeficitArea, { icon: string; image: string; gradient: [string, string]; bgLight: string }> = {
  phonological_awareness: {
    icon: "Ear",
    image: "/game-images/category_phonological.png",
    gradient: ["#6366F1", "#818CF8"],
    bgLight: "#EEF2FF",
  },
  rapid_naming: {
    icon: "Zap",
    image: "/game-images/category_rapid_naming.png",
    gradient: ["#F59E0B", "#FBBF24"],
    bgLight: "#FFFBEB",
  },
  working_memory: {
    icon: "Brain",
    image: "/game-images/category_working_memory.png",
    gradient: ["#8B5CF6", "#A78BFA"],
    bgLight: "#FAF5FF",
  },
  visual_processing: {
    icon: "Eye",
    image: "/game-images/category_visual_processing.png",
    gradient: ["#10B981", "#34D399"],
    bgLight: "#ECFDF5",
  },
  reading_fluency: {
    icon: "BookOpen",
    image: "/game-images/category_reading_fluency.png",
    gradient: ["#3B82F6", "#60A5FA"],
    bgLight: "#EFF6FF",
  },
  comprehension: {
    icon: "Lightbulb",
    image: "/game-images/category_comprehension.png",
